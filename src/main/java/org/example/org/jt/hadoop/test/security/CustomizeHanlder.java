package org.example.org.jt.hadoop.test.security;
...
import java.util.Properties;
     ...
     * </ul>
     */
    public class CustomizeHanlder implements AuthenticationHandler {
         ...
         */
        public CustomizeHanlder(String type) {
            this.type = type;
            LOG.info("AUTHJT-I am the customeize logger");
        }
        ...
        public void init(Properties config) throws ServletException {
            ...
            adminUserName = config.getProperty("cust.admin.name", "ts_sup");
            LOG.info("the admin username :" + this.adminUserName);
        }
        ...
        public boolean managementOperation(AuthenticationToken token,
            ...
            LOG.info("AUTHJI-I:" + "Going to print the token");
            LOG.info("AUTHJT-I:" + "I am readying the token-" + (token == null? "N/A": token.getUserName()));
            return true;
        }
        ...
        public AuthenticationToken authenticate(HttpServletRequest request, HttpServletResponse response)
            ...
            LOG.info("AUTHJT-I ,the username :" + userName);
            ...
            boolean  checkRequired = portList.contains(String.valueOf(serverPort)) && !requestURI.contains("/imagetransfer");

            if (checkRequired) {
                LOG.info("check is required for port:"+ serverPort +",the admin username:" + adminUserName);
